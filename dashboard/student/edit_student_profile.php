        ...
        <form action="../../includes/process_edit_profile.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="emergency_contact" class="form-control" value="<?= htmlspecialchars($student['emergency_contact'] ?? '') ?>" required>
          ...
          <div class="mb-3">
            ...
            <?php if (!empty($student['photo'])): ?>
              <img src="../../uploads/<?= htmlspecialchars($student['photo']) ?>" alt="Current Photo" class="rounded mb-2" width="100" height="100" style="object-fit: cover;">
            <?php else: ?>
              <img src="../../assets/img/default_user.png" alt="No Photo" class="rounded mb-2" width="100" height="100" style="object-fit: cover;">
          ...
          <div class="mb-3">
            ...
            <small class="text-muted">Required for ID card. Accepted formats: JPG, PNG, GIF. Max size: 2MB</small>
          </div>
